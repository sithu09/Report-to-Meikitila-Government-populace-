...
public class MunicipalInsert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_municipal_insert);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reff= FirebaseDatabase.getInstance().getReference("MunicipalInsert");
                ...
                if(dates.length()==0 || titles.length()==0 || provides.length()==0 || prposals.length()==0 ){
                    Toast.makeText(MunicipalInsert.this,"ပြည့်စုံစွာ ဖြည့်စွက်ပေးပါ",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Toast.makeText(MunicipalInsert.this," သင်၏ တိုင်ကြားချက်ကို လက်ခံရရှိပါသည်။ ",Toast.LENGTH_LONG).show();
                }
        ...
        mnews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MunicipalInsert.this, MunicipalNews.class);
